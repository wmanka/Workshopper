...
namespace Workshopper.Infrastructure.Common.Persistence.Migrations
{
    ...
    [Migration("20240211152745_ReplaceUserProfileWithUserIdForNotifications")]
    partial class ReplaceUserProfileWithUserIdForNotifications
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Workshopper.Domain.Notifications.NotificationSubscription", b =>
                {
                    ...
                    b.HasKey("NotificationType", "NotificationDeliveryType", "UserId")
                        .HasName("pk_notification_subscriptions");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_notification_subscriptions_user_id");

                    b.HasIndex("NotificationType", "NotificationDeliveryType", "UserId")
                        .IsUnique()
