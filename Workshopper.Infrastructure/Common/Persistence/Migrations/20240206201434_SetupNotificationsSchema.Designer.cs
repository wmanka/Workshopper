...
namespace Workshopper.Infrastructure.Common.Persistence.Migrations
{
    ...
    [Migration("20240206201434_SetupNotificationsSchema")]
    partial class SetupNotificationsSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Workshopper.Domain.Notifications.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("RecepientId")
                        .HasDatabaseName("ix_notifications_recepient_id");

                    b.ToTable("notifications", "notifications");
                });

            modelBuilder.Entity("Workshopper.Domain.Notifications.NotificationSubscription", b =>
                {
                    b.Property<string>("NotificationType")
                        .HasColumnType("text")
                        .HasColumnName("notification_type");

                    b.Property<string>("NotificationDeliveryType")
                        .HasColumnType("text")
                        .HasColumnName("notification_delivery_type");

                    b.Property<Guid>("UserProfileId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_profile_id");

                    b.HasKey("NotificationType", "NotificationDeliveryType", "UserProfileId")
                        .HasName("pk_notification_subscriptions");

                    b.HasIndex("UserProfileId")
                        .HasDatabaseName("ix_notification_subscriptions_user_profile_id");

                    b.HasIndex("NotificationType", "NotificationDeliveryType", "UserProfileId")
                        .IsUnique()
                        .HasDatabaseName("ix_notification_subscriptions_notification_type_notification_d");

                    b.ToTable("notification_subscriptions", "notifications");
                });
            ...
            modelBuilder.Entity("Workshopper.Domain.Notifications.Notification", b =>
                {
                    b.HasOne("Workshopper.Domain.Users.UserProfiles.UserProfile", "Recepient")
                        .WithMany()
                        .HasForeignKey("RecepientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_notifications_user_profiles_recepient_id");
            ...
            modelBuilder.Entity("Workshopper.Domain.Notifications.NotificationSubscription", b =>
                {
                    b.HasOne("Workshopper.Domain.Users.UserProfiles.UserProfile", "UserProfile")
                        .WithMany()
                        .HasForeignKey("UserProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_notification_subscriptions_user_profiles_user_profile_id");
